...
for image_set in sets:
    if not os.path.exists('C:/Users/User/Desktop/yolov7/ETAS/labels/'):
        os.makedirs('C:/Users/User/Desktop/yolov7/ETAS/labels/')
    image_ids = open('C:/Users/User/Desktop/yolov7/ETAS/ImageSets/Main/%s.txt' % (image_set)).read().strip().split()

    if not os.path.exists('C:/Users/User/Desktop/yolov7/ETAS/dataSet_path/'):
        os.makedirs('C:/Users/User/Desktop/yolov7/ETAS/dataSet_path/')
    # 这行路径不需更改，这是相对路径
    list_file = open('dataSet_path/%s.txt' % image_set, 'w')

    # 图片格式为jpg则设置为 .jpg, 如果为png则设置为 .png。否则会出现路径找不到的问题
    for image_id in image_ids:
        list_file.write('C:/Users/User/Desktop/yolov7/ETAS/images/%s.jpg\n' % image_id)
